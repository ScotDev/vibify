...
const icon = (title: string) => {
  switch (title) {
    ...
    case "k-pop":
      return (
        <h3
          className={`${noto_sans_kr.className} font-medium text-[64px] text-center `}
        >
          케이팝
        </h3>
      );
    ...
    case "custom":
      return (
        <h3 className="font-medium text-[128px] leading-none text-center">+</h3>
      );
      break;
    default:
      return (
  ...
  return (
    <Link href={`/step2/?seed=${title}`}>
      <div
        ...
        className="bg-black w-[250px] aspect-square p-6 grid cursor-pointer transition-all hover:translate-x-2 hover:-translate-y-2 card"
